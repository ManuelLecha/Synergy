...
public class DoneOwnProjectActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    private void setViewComponentData() {
        ...
        participantsListAdapter = new ParticipantListViewAdapter(DoneOwnProjectActivity.this);
        ...
        participantsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(user != null) {
                    Intent i = new Intent(new Intent(DoneOwnProjectActivity.this, AlienProfileActivity.class));
        ...
        Presenter.getInstance().setUserImageToContext(project.getAdmin(), DoneOwnProjectActivity.this, profileImgvw);
        profileImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DoneOwnProjectActivity.this, UserProfileActivity.class);
