...
public class AvailableOfferModel extends PostModel {
    public AvailableOfferModel(String id, String adminUid, Location location, String title, String description, PostType postType) {
        super(id, adminUid, location, title, description, postType);
    }

    public AvailableOfferModel(){
        super();
    }
