...
import ub.edu.pis2017.pis_17.synergy.View.Dialogs.Runnables.FinishOwnOngoingPost.FinishRequestWithMemoirRunnable;
...
public class OngoingOwnRequestActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    private void setViewComponentData() {
        ...
        finishFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setFinishRunnable(new FinishRequestWithMemoirRunnable(request, OngoingOwnRequestActivity.this,dialog));
        ...
        //adminImgvw content
        Presenter.getInstance().setUserImageToContext(request.getAdmin(), OngoingOwnRequestActivity.this, adminImgvw);
        adminImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(OngoingOwnRequestActivity.this, UserProfileActivity.class);
        ...
        Presenter.getInstance().setUserImageToContext(request.getParticipant(), OngoingOwnRequestActivity.this, participantImgvw);
