...
public class OngoingAlienProjectActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_alien_ongoing_many_participant_post);

        findViewById(R.id.content_show_many_participant_post).setVisibility(View.INVISIBLE);

        //instantiate view components
        progressBar = (ProgressBar) findViewById(R.id.alien_ongoing_many_participant_pgrsbar);
        initHashtagShower();
    ...
    private void setViewComponentData() {
        ...
        participantsListAdapter = new ParticipantListViewAdapter(OngoingAlienProjectActivity.this);
        ...
        participantsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(user != null) {
                    Intent i = new Intent(new Intent(OngoingAlienProjectActivity.this, AlienProfileActivity.class));
        ...
        Presenter.getInstance().setUserImageToContext(project.getAdmin(), OngoingAlienProjectActivity.this, profileImgvw);

        //titleTxtvw content
        titleTxtvw.setText(project.getTitle());
        titleTxtvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(OngoingAlienProjectActivity.this, AlienProfileActivity.class);
    ...
    public void initToolBar(){
        toolbar = (Toolbar) findViewById(R.id.alien_ongoing_many_participant_toolbar);
