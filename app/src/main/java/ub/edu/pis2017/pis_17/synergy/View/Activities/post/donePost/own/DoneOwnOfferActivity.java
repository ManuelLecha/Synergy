...
public class DoneOwnOfferActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    private void setViewComponentData() {
        ...
        //adminImgvw content
        Presenter.getInstance().setUserImageToContext(offer.getAdmin(), DoneOwnOfferActivity.this, adminImgvw);
        adminImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DoneOwnOfferActivity.this, UserProfileActivity.class);
        ...
        Presenter.getInstance().setUserImageToContext(offer.getParticipant(), DoneOwnOfferActivity.this, participantImgvw);
