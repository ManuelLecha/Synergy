...
public class DoneAlienProjectActivity extends AppCompatActivity implements ProgressBarToggleable {

    private DoneProject project;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_done_many_participant_post);

        findViewById(R.id.content_show_many_participant_post).setVisibility(View.INVISIBLE);

        //instantiate view components
        progressBar = (ProgressBar) findViewById(R.id.done_many_participant_pgrsbar);
        initHashtagShower();
        participantsListView = (ListView) findViewById(R.id.show_many_participant_participants_lstvw);
        initToolBar();
        memoirFab = (FloatingActionButton) findViewById(R.id.done_many_participant_memoir_fabitem);
        ...
        postBox.whenFull(databaseProject -> {
            project = (DoneProject) databaseProject;
        });
    ...
    private void setViewComponentData() {
        ...
        participantsListAdapter = new ParticipantListViewAdapter(DoneAlienProjectActivity.this);
        ...
        participantsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(user != null) {
                    Intent i = new Intent(new Intent(DoneAlienProjectActivity.this, AlienProfileActivity.class));
        ...
        memoirFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setMemoir(project.getMemoir());
                dialog.setTitle(project.getTitle());
                dialog.show(fm, "Memoir dialog");
            }
        });

        //profileImgvw content
        Presenter.getInstance().setUserImageToContext(project.getAdmin(), DoneAlienProjectActivity.this, profileImgvw);
        profileImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DoneAlienProjectActivity.this, AlienProfileActivity.class);
    ...
    public void initToolBar(){
        toolbar = (Toolbar) findViewById(R.id.done_many_participant_toolbar);
