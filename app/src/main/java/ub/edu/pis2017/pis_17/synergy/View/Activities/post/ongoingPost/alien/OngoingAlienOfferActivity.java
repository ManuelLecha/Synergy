...
public class OngoingAlienOfferActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    private void setViewComponentData() {
        ...
        //adminImgvw content
        Presenter.getInstance().setUserImageToContext(offer.getAdmin(), OngoingAlienOfferActivity.this, adminImgvw);
        adminImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(OngoingAlienOfferActivity.this, AlienProfileActivity.class);
        ...
        Presenter.getInstance().setUserImageToContext(offer.getParticipant(), OngoingAlienOfferActivity.this, participantImgvw);
