...
public class DoneAlienRequestActivity extends AppCompatActivity implements ProgressBarToggleable {
    ...
    private void setViewComponentData() {
        ...
        //adminImgvw content
        Presenter.getInstance().setUserImageToContext(request.getAdmin(), DoneAlienRequestActivity.this, adminImgvw);
        adminImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DoneAlienRequestActivity.this, AlienProfileActivity.class);
        ...
        Presenter.getInstance().setUserImageToContext(request.getParticipant(), DoneAlienRequestActivity.this, participantImgvw);
