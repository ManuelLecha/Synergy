...
import ub.edu.pis2017.pis_17.synergy.View.Dialogs.Runnables.FinishOwnOngoingPost.FinishOfferWithMemoirRunnable;
...
public class OngoingOwnOfferActivity extends AppCompatActivity implements ProgressBarToggleable {

    private OngoingOffer offer;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_own_ongoing_one_participant_post);

        findViewById(R.id.content_show_one_participant_with_post).setVisibility(View.INVISIBLE);

        //instantiate view components
        progressBar = (ProgressBar) findViewById(R.id.own_ongoing_one_participant_pgrsbar);
        initHashtagShower();
        initToolBar();
        finishFab = (FloatingActionButton) findViewById(R.id.own_ongoing_one_participant_finish_fabitem);
        ...
        postBox.whenFull(databaseOffer -> {
            offer = (OngoingOffer) databaseOffer;
        });
    ...
    private void setViewComponentData() {
        ...
        finishFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setFinishRunnable(new FinishOfferWithMemoirRunnable(offer, OngoingOwnOfferActivity.this,dialog));
        ...
        //adminImgvw content
        Presenter.getInstance().setUserImageToContext(offer.getAdmin(), OngoingOwnOfferActivity.this, adminImgvw);
        adminImgvw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(OngoingOwnOfferActivity.this, UserProfileActivity.class);
        ...
        Presenter.getInstance().setUserImageToContext(offer.getParticipant(), OngoingOwnOfferActivity.this, participantImgvw);
    ...
    public void initToolBar(){
        toolbar = (Toolbar) findViewById(R.id.own_ongoing_one_participant_toolbar);
